...
contract Pedigree is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pedigreev7.3.0";
    string private constant _symbol = "Pedigree7.3.0";
    ...
    function transferERC20(IERC20 tokenContract, address to, uint256 amount) public {
        require(messageSender() == teamWallet || messageSender() == owner(), "Only fee owner can withdraw funds"); 
